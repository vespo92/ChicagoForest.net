...
const packages: Package[] = [
  ...
  {
    name: 'mnp',
    fullName: '@chicago-forest/mnp',
    description: 'Experimental MNP protocol with 256-bit addresses and mesh-native routing',
    category: 'networking',
    features: [
    ...
    installCommand: 'npm install @chicago-forest/mnp',
    status: 'alpha',
    icon: '🌐',
  },
  {
    name: 'mnp-adapter',
    fullName: '@chicago-forest/mnp-adapter',
    description: 'Bridge between MNP and traditional IPv4/IPv6 networks',
    category: 'networking',
    features: [
      'Address translation',
    ...
    installCommand: 'npm install @chicago-forest/mnp-adapter',
    status: 'alpha',
    icon: '🔄',
  },
  {
